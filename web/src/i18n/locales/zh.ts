const zh = {
  ...
  "licenses.resendEmail": "重发邮件",
  "licenses.resendEmailConfirm": "再向 {email} 发送一次许可证密钥？适用于客户没收到第一封邮件的情况。",
  "licenses.resendEmailAction": "发送",
  "licenses.revoke": "吊销",
  ...
  "settings.emailProvider": "服务商",
  "settings.emailProviderDesc": "邮件的发送方式。Cloudflare Email 走 HTTPS，主机封锁 SMTP 端口时更可靠。",
  "settings.emailFromDesc": "邮件的发件地址，须是服务商处已验证的发信人。",
  "settings.emailPort": "SMTP 端口",
  "settings.emailUsername": "SMTP 用户名",
  "settings.emailPassword": "SMTP 密码",
  "settings.emailCfAccount": "账户 ID",
  "settings.emailApiToken": "API 令牌",
  "settings.secretSaved": "•••••••• (已保存)",
  "settings.secretKeepHint": "留空则保留当前值。",
  "settings.secretClear": "清除",
  "settings.secretCleared": "密钥已清除",
  "settings.emailEnvBanner": "当前邮件配置来自环境变量。在此保存后改为由后台管理。",
  "settings.testEmailToPlaceholder": "收件人（默认发给你自己）",
  "settings.testEmailDirtyHint": "保存改动后即可测试 —— 测试使用已保存的配置。",
  "settings.testEmailSaveHint": "发送测试前请先保存 —— 测试使用已保存的配置。",
  ...
  "toast.licenseEmailQueued": "许可证邮件已在发往 {email} 的路上。",
